 ...
 */
public class FileServlet extends AbstractGalleryServlet {

    /**
	 * 
	 */
	private static final long serialVersionUID = 311993189795132919L;
            ...
            throws IOException
    {
    	try
    	{
	        ...
	        File file = new File(getBaseDir(request.getUserPrincipal()), URLDecoder.decode(requestedFile, "UTF-8"));
	        ...
	        // Change the filename, possibly
	        file = mutateFile(request.getUserPrincipal(), request.getParameterMap(), file, requestedFile);
